  ...
  const steps = [
    {
      step: "01",
      title: "Post Parcel",
      description: "Create a listing with parcel details, destination, and delivery timeline.",
      icon: (
    ...
    },
    {
      ...
      description: "Get matched with verified travelers going to your destination.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Simple steps to send your parcel anywhere in the world
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="text-center">
              <div className="relative mb-8">
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 text-blue-600 rounded-full absolute -bottom-2 -right-2">
                  {step.icon}
                </div>
